...
# TODO: Need to target a sandbox / test NiceHash API
# by setting relevant environment variables for that
# in env.json
...
#     response = lambda_client.invoke(FunctionName="NiceHashWithdrawBtcFn")
