...
A withdrawal address is also required. You can view your addresses [here](https://www.nicehash.com/my/settings/withdraw-addresses). If you know your NiceHash internal address ID, you can use that directly. If you do not know what that is, you should use the address type and address. For Coinbase, address type is simply `COINBASE` and address is your coinbase account email. For bitcoin withdrawal addresses, you would use an address type of `BITGO` and the bitcoin address.
